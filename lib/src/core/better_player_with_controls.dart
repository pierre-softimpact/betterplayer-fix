...
import 'package:better_player/src/controls/better_player_unified_controls.dart';
...
class _BetterPlayerWithControlsState extends State<BetterPlayerWithControls> {
  ...
  Widget _buildControls(
    ...
    if (controlsConfiguration.showControls) {
      ...
      } else if (playerTheme == BetterPlayerTheme.unified) {
        return _buildUnifiedControls();
      }
    }
  ...
  Widget _buildUnifiedControls() {
    return BetterPlayerUnifiedControls(
        onControlsVisibilityChanged: onControlsVisibilityChanged, controlsConfiguration: controlsConfiguration);
  }
